      ...
      <div className="body-text">
        ...
        <Col sm={12} md={6}>
                ...
                <div className="profile-div">
                  <center>
                <Image className="profile justify-content-end" alt="profile" src={Profile} fluid /><div className="credit">Dr. Samrat Mukherjee<br/>
Professor – In charge,
<br/>
...
<br/>
          ...
          <Col sm={12} md={6}>
                <div className="profile-div">
                  <center>
                <Image className="profile justify-content-end" alt="profile" src={Profile2} fluid />
